...
//for validating email and password while user types
  ...
  Password
      get password; //we should not show error message initially while user types email
//but afer user press signin or register button, then we show error message
//from email and password validaton
  bool
      get showErrorMessage; //when user hits button then we should show loading screen
  bool
      get isSubmitting; //when details are wrong we should show error message or success,
...
class _$_SignInFormState implements _SignInFormState {
  ...
  @override //for validating email and password while user types
  final EmailAddress emailAddress;
  @override
  final Password password;
  @override //we should not show error message initially while user types email
//but afer user press signin or register button, then we show error message
//from email and password validaton
  final bool showErrorMessage;
  @override //when user hits button then we should show loading screen
  final bool isSubmitting;
  @override //when details are wrong we should show error message or success,
//but initially neither success or error is returned by server so we used Option
//to initially use of none which represents no value is present.
//https://youtu.be/1P7q51rkPZw?t=1262
